                        ...
                        <div class="flex justify-between sm:col-span-3 p-1 group">
                            <div class="lg:w-80">
                                <x-link href="{{ route('reports.show', $report->id) }}" class="flex" override="class">
                                    ...
                                    <div class="ltr:ml-2 rtl:mr-2 text-black">
                                        <h2 class="mb-1">
                            ...
                            <div class="flex items-start ltr:space-x-2 rtl:space-x-reverse">
                                ...
                                <x-dropdown id="index-line-actions-report-{{ $category_id }}-{{ $report->id }}">
                                    <x-slot name="trigger" class="flex" override="class">
                                        <span class="w-8 h-8 flex items-center justify-center px-2 py-2 rtl:mr-4 hover:bg-gray-100 rounded-xl text-black text-sm font-medium leading-6">
                                            <span class="material-icons pointer-events-none text-black">more_vert</span>
                                        </span>
                                    </x-slot>
